...
def generate(cfg: GenerateConfig) -> None:
    overwatch.info(f"Initializing Generation Playground with EMMA `{cfg.model_path}`")
    ...
    print(
        "[*] Dropping into EMMA VLM REPL with Default Generation Setup => Initial Conditions:\n"
