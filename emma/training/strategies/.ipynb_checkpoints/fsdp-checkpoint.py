...
from emma.training.strategies.base_strategy import TrainingStrategy
    ...
    def save_checkpoint(
        ...
        with FSDP.state_dict_type(self.vlm, self.fsdp_state_dict_type, self.fsdp_save_policy):
            ...
            if overwatch.is_rank_zero():
                ...
                print("SAVING CURRENT CKPT")
                torch.save({"model": model_state_dicts, "scheduler": self.lr_scheduler, "optimizer": self.optimizer}, checkpoint_path)
    ...
    def run_setup(self, run_dir: Path, n_train_examples: int) -> None:
        ...
        if self.enable_mixed_precision_training and self.mixed_precision_dtype == torch.bfloat16:
            ...
            if True:
                ...
                overwatch.info("Not Casting Vision Backbone to *Half Precision* via `.to(dtype=...)`")
        else:
