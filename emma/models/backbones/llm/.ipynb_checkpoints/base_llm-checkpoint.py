...
class HFCausalLLMBackbone(LLMBackbone, ABC):
    def __init__(
        ...
        if llm_backbone_id == "mobilellama-2.7b":
            return 
        ...
        # [Contract] `inference_mode` means we're loading from a pretrained checkpoint; no need to load base weights!
            ...
            if llm_backbone_id == "mamba-2.7b-v2":
                self.llm = llm_cls.from_pretrained(
                hf_hub_path,
                token=hf_token,
                use_flash_attention_2=use_flash_attention_2 if not self.inference_mode else False,
        ...
        try:
            ...
            print("use_cache attribute of self.llm not found")
        ...
        if not self.inference_mode:
            try:
                ...
                print("Mamba V2 requires grad = True")
        ...
        if not self.tokenizer.pad_token_id:
            print("Setting tokenizer pad id to 1")
